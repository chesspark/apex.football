      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          {([
            ...
            >
              {key === "live" && <span className="w-2 h-2 bg-red-500 rounded-full animate-pulse" />}
              {label}
        ...
        <div className="bg-[var(--surface)] border border-[var(--border-clr)] rounded-2xl overflow-hidden">
          {/* Header */}
          <div className="grid grid-cols-12 gap-2 px-4 py-3 border-b border-[var(--border-clr)] text-[10px] font-bold uppercase tracking-wider text-[var(--muted)]">
            <div className="col-span-2">Status</div>
            <div className="col-span-3 text-right">Home</div>
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map((match) => {
              ...
              return (
                <div
                  key={match.id}
                  className={`grid grid-cols-12 gap-2 px-4 py-3 items-center border-b border-[var(--border-clr)] last:border-0 transition-colors hover:bg-[var(--surface-hover)] ${
                ...
                >
                  ...
                  <div className="col-span-2 flex items-center justify-between">
                    <span className="text-[10px] text-[var(--muted)] truncate">{match.tournament}</span>
