        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 bg-gradient-to-br from-[var(--accent)] to-[var(--accent-green)] rounded-lg flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["nav.home", "nav.players", "nav.tournaments", "nav.results", "nav.live"].map(
                (key) => (
                  <li key={key}>
                    <a href="#" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                      {t(key)}
                    </a>
                  </li>
                )
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href="#" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">{t("footer.privacy")}</a></li>
              <li><a href="#" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">{t("footer.terms")}</a></li>
            </ul>
          </div>
        </div>
