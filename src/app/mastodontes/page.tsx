...
import MastodontesExperience from "@/components/mastodontes/MastodontesExperience";
  ...
  return (
    <main className="min-h-screen bg-[#050508] text-[#e8e8ec]">
      ...
      <div className="pt-24 pb-20 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="relative overflow-hidden rounded-3xl border border-[#D4AF37]/25 bg-gradient-to-br from-[#0c0c10] via-[#101018] to-[#060608] p-8 sm:p-12 mb-10 mastodontes-hero-glow">
          <div className="absolute top-0 right-0 w-72 h-72 bg-[#D4AF37]/8 rounded-full blur-3xl motion-safe:animate-pulse" />
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-10">
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 flex items-start gap-3 backdrop-blur-sm hover:border-[#D4AF37]/20 transition-colors">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 flex items-start gap-3 backdrop-blur-sm hover:border-emerald-500/20 transition-colors">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 flex items-start gap-3 backdrop-blur-sm hover:border-sky-500/20 transition-colors">
        ...
        <MastodontesExperience rows={rows} meta={meta} />
      </div>
      <Footer />
    </main>
  );
